 ...
 * starting location of the bottles as well as their each move through the grid
 */
            ...
            for (int i = 0; i < bottles.size(); i++) {
              ...
              /*we will check if the bottle can do a valid move using the isValidMove method and passing in
                ...
                if (bottle.isValidMove(earthGrid)) {
                  ...
                  /*after moving the bottle we output the counter the bottle name and the directions of the movement
                    and the direction*/
